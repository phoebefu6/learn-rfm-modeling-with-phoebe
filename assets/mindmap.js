/* mindmap.js - reusable knowledge-map layer for the learn-X-with-phoebe courses.
   ...
   window.MINDMAP_DATA = {
     ...
     centerColor: "#3A2340",
     sessions: [
       { label:"Frame & charter", href:"courses/01-...html", color:"#7FD8CB",
...
(function () {
  ...
  var C_ACCENT = theme("--indigo", "#8A6A12");        // session fill + trunk
  var C_DEEP   = theme("--indigo-deep", "#3A2340");   // root fill
  var C_SOFT   = theme("--indigo-soft", "#D6C7DA");   // concept border
  var C_TINT   = theme("--indigo-50", "#F5F0F6");     // concept fill
  var C_INK    = theme("--ink", "#2B1B30");           // concept text
  var C_FAINT  = theme("--faint", "#DACEDD");         // twig edges
